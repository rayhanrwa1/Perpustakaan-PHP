            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <table id="deskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <label class="col-sm-12 control-label"><center><strong>PERPUSTAKAAN UMM</strong></center></label>
                            <p align="center">
                        ...
                        <tbody>
                          ...
                          <div class="col-sm-8" align="center">
                            <br>
                            Telp. 085904390709<br>
                            Email : perpusumm@webmail.com<br>
                            Fax : 1234567<br>
                            Website : perpusumm.go.id<br>
                            <br>
                          </div>
                          <div class="col-sm-2" align="center">
                          </div>
